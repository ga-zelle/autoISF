...
The new features on the AutoISF side provided by the upgrade from 3.2.0 to 3.2.1 are:
...
* Improved logic in steps counts for identifying getting up when using the *Sleeping state*
