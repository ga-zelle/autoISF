...
userange = StringVar()
chkrange = ttk.Checkbutton(glucframe, text='Show range', \
            command=userangeChanged, variable=userange, onvalue='on', offvalue='off')
chkrange.grid(column=0, row=7, columnspan=2, sticky=(W), padx=5)

def useslopeChanged():   act(useslope.get(), "slope")
useslope = StringVar()
chkslope = ttk.Checkbutton(glucframe, text='Show slope', \
            command=useslopeChanged, variable=useslope, onvalue='on', offvalue='off')
chkslope.grid(column=0, row=8, columnspan=2, sticky=(W), padx=5)
...
chkISF.grid(column=0, row=9, columnspan=2, sticky=(W), padx=5)
...
chkpred.grid(column=0, row=10, columnspan=2, sticky=(W), padx=5)
